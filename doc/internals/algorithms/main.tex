...
\begin{enumerate}
	\item
		...
		\begin{proof}
			...
			Assume that $e$ and $e'$ share no parent, because $\lceil e \rceil \cup e'$ as well as $\lceil
			e' \rceil \cup e$ is a configuration, $e || e'$ which means $\lnot (e \cfl e')$
			
		\end{proof}			
		
		To decide if they are in conflict, just check their parents together. If there is at least one
		shared parent between them, they are in direct conflict. Otherwise, they are not. Let us take
