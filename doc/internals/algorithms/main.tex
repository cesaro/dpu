...
\begin{algorithm}
\noindent
For each event $e \in C$ such that \verb!e->trans == t! and $e$ is not an event located between a pair of (LOCK, UNLOCk), repeat the following:
\begin{enumerate}
...
\begin{algorithm}
\noindent
For each event $e \in C$ such that $e$ is not an event located between a pair of (LOCK, UNLOCk) and \verb!e->trans == t!, repeat the following:
\begin{enumerate}
\item Set \verb!ep = e->pre_proc!
\item Set \verb!ew = e!
\item
