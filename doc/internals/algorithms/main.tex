...
\begin{enumerate}
	\item
		...
		created and added to enable set. However, at that time, we can't say anything about the
		conflict or causality between events because it is not explored yet. Just when an event 
		$e$ is explored (added to a configuration C), the relation among events is changed, so we
	...
	\item
		...
		\begin{itemize}
			\item
				...
				\begin{itemize}
					\item
						Check conflict between every maximal event of C with J. If there is some
						conflict, discard J
					\item
