...
\begin{itemize}
	\item e and e' are in the same process: $p(e) = p(e')$ -> use Alg.05
	\item e and e' are in different processes: $p(e)\neq p(e')$
		\begin{itemize}
			\item touch the same variable: $v(e) = v(e')$ and $ type(e) = type(e') = WR$ -> use Alg.05
			\item touch the same variable: $v(e) = v(e')$ and $ type(e) = type(e') = SYN$ -> use Alg.05
