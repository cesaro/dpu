	...
	\item e and e' are in different processes: $p(e)\neq p(e')$
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item
					$w_1 < w_2$, then $e < e'$ or $e \cfl e'$. To determine the case (*), find the event WR' which satisfies: $w'< w_2$ and $w'.pre\_mem = w_1 $
				\begin{itemize}
					\item
						e < w: $e < e'$
					\item
						e is not causal to w': $e \cfl e'$
				\end{itemize}					
				
			\end{itemize}
			\item 
				touch the same variable: $v(e) = v(e')$ and e is a WR and e' is a RD. Find the latest WR predecessor of e', called w'. Apply  \cref{a:layer_tree} for WR tree to determine if e and w' are in conflict or not.
				\begin{itemize}
					\item
						If $w'\cfl e$: $e \cfl e'$
					\item
						If $ w'< e$ or $e < w'$, do as the case (*) with 2 reads.
				\end{itemize}
