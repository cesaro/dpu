...
void outputAlloca( llvm::Module* , llvm::Instruction* ins, machine_t* machine, llvm::Value* tid ) {
...
void outputLoad( llvm::Module* , llvm::Instruction* ins, machine_t* , llvm::Value* tid ) {
    std::string name = (ins->hasName()) ? ins->getName().str() : getShortValueName( ins );
...
void outputStore( llvm::Module* , llvm::Instruction* ins, machine_t* , llvm::Value* tid ) {
...
void outputCall( llvm::Module* , llvm::Instruction* ins, machine_t* machine, llvm::Value* ) {
    llvm::Function *fun;
    llvm::Value* val;
...
void outputReturn( llvm::Module* , llvm::Instruction* ins, machine_t* , llvm::Value* ) {
...
void outputBranch( llvm::Module* , llvm::Instruction* ins, machine_t* , llvm::Value* ) {
...
void outputIcmp( llvm::Module* , llvm::Instruction* ins, machine_t* , llvm::Value* ) {
...
void outputUnknown( llvm::Module* , llvm::Instruction* ins, machine_t* , llvm::Value* ) {
