...
# xxx 2 xxx
# dpu: summary: 2 max-configs, 0 SSBs, 30 events, 18.0 ev/trail
# xxx 3 xxx
# dpu: summary: 6 max-configs, 0 SSBs, 98 events, 26.0 ev/trail
# xxx 4 xxx
# dpu: summary: 24 max-configs, 0 SSBs, 394 events, 34.0 ev/trail
# xxx 5 xxx
# dpu: summary: 120 max-configs, 0 SSBs, 1962 events, 42.0 ev/trail
# xxx 6 xxx
# dpu: summary: 720 max-configs, 0 SSBs, 11750 events, 50.0 ev/trail
# xxx 7 xxx
# dpu: summary: 5040 max-configs, 0 SSBs, 82210 events, 58.0 ev/trail
